...
🚀 Installation & Deployment
    ...
    Set up environment variables: Edit the .env file to set your LLM API endpoints and optionally define a DATABASE_URL if bypassing the default SQLite setup.

    Ensure Local Volume Persistence: The docker-compose.yml automatically mounts the ./data directory to share the SQLite database file across the web, worker, and webhook containers.
