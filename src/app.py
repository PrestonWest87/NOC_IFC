...
if page == "👁️ Global Dashboards":
    ...
    with dash_tabs[3]:
        ...
        if sys_config and getattr(sys_config, 'unified_brief', None):
            ...
            if c_em2.button("✉️ Transmit Brief", type="primary", width='stretch'):
            ...
            with rg_tabs[rg_idx]:
                ...
                with c_ctrl:
                    ...
                    with st.container(border=True):
                        ...
                        st.divider()
                        map_toggles["spc"] = st.toggle("⛈️ SPC Convective", value=False)
                        map_toggles["warn"] = st.toggle("🚨 Warnings (AR)", value=False)
                        map_toggles["watch"] = st.toggle("⚠️ Watches (AR)", value=False)
