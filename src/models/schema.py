...
class SystemConfig(Base):
    ...
    global_brief = Column(Text, nullable=True)
    global_brief_time = Column(DateTime, nullable=True)
    internal_brief = Column(Text, nullable=True)
    internal_brief_time = Column(DateTime, nullable=True)
