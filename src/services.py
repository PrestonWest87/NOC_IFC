...
# ==========================================
# 1. CORE CACHED SERVICES (Memory Capped!)
# ==========================================
...
# ==========================================
# 3. DASHBOARD & TELEMETRY FETCHERS
# ==========================================
...
# ==========================================
# 4. REPORTING, HUNTING & ARTICLE ACTIONS
# ==========================================
...
# ==========================================
# 5. AIOPS & GEOSPATIAL HEAVY LIFTING
# ==========================================
...
def process_nws_alerts(data, selected_events, is_oos=False):
    ...
    for idx, f_raw in enumerate(data.get("features", [])):
        ...
        if geom:
            ...
            # STRICT GUARD: Never map OOS county names to AR county maps!
            if is_oos:
        ...
        # --- THE MEMORY FIX: MICRO-FEATURES ---
        # Eliminate deepcopy to drop redundant multi-megabyte payloads
        for g in geometries_to_process:
            try:
                ...
                # We build a tiny, isolated dictionary for PyDeck, leaving massive metadata behind!
                micro_feature = {
                    "type": "Feature",
                    "geometry": g,
                    "properties": {
...
def calculate_site_intersections(map_df, active_polygons):
    """Finds physical IT sites residing inside severe weather geometry."""
...
# ==========================================
# 6. ADMIN & SETTINGS SERVICES
# ==========================================

# ==========================================
# 8. USER & ROLE ADMINISTRATION
# ==========================================
